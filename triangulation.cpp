...
int main(int argc, char** argv) {
    ...
    cout << "We found " << matches.size() << " pair of feature points" << endl << endl;

    // Estimate the motion between 2 images
    Mat R, t;
...
void triangulation(
    ...
    for(DMatch m:matches) {
        // Convert pixel coordinate into camera coordinate
    ...
    // convert into non homogeneous coordinate
